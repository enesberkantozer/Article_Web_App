...
namespace ArticleCheck.WebApi.Migrations
{
    ...
    [Migration("20250327171924_addInterestTable")]
    partial class addInterestTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HakemInterest", b =>
                {
                    b.Property<int>("HakemsId")
                        .HasColumnType("int");

                    b.Property<int>("InterestsId")
                        .HasColumnType("int");

                    b.HasKey("HakemsId", "InterestsId");

                    b.HasIndex("InterestsId");

                    b.ToTable("HakemInterest");
                });
            ...
            modelBuilder.Entity("HakemInterest", b =>
                {
                    b.HasOne("ArticleCheck.WebApi.Entities.Hakem", null)
                        .WithMany()
                        .HasForeignKey("HakemsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
